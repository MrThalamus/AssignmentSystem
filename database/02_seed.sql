...
VALUES
  ...
  ('00000000-0000-0000-0000-000000000012', 'Farhana Akter',  'farhana.akter@school.edu',
   '100000.7WZjfRZtdwwyQ/LpxDnLFg==.gEAaDjy/pL0+VxA6K4bw72WBIXFZ4VlrYVVPufaep4c=', 'Teacher', TRUE, now()),
  ('00000000-0000-0000-0000-000000000013', 'Habib Wahid',    'habib.wahid@school.edu',
   '100000.7WZjfRZtdwwyQ/LpxDnLFg==.gEAaDjy/pL0+VxA6K4bw72WBIXFZ4VlrYVVPufaep4c=', 'Teacher', TRUE, now()),
...
VALUES
  ...
  -- Habib's own class, so the third teacher can actually set work.
  ('00000000-0000-0000-0000-000000000305', '00000000-0000-0000-0000-000000000201',
   '00000000-0000-0000-0000-000000000102', '00000000-0000-0000-0000-000000000013', now())
ON CONFLICT ("Id") DO NOTHING;
